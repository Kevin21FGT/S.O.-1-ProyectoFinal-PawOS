...
Sube el numero de version de PawOS Refugio de 1.3 a 1.4 en
include/version.h.

Uso: parado en la raiz del repo:
    python3 subir-version-1.4.py
"""
...
ANCLA = '#define PAWOS_VERSION "1.3"'
NUEVO = '#define PAWOS_VERSION "1.4"'
...
def main():
    ...
    if contenido.count(ANCLA) != 1:
        ...
        print("       Puede que la version ya no sea 1.3, o que el archivo ya haya sido modificado.")
    ...
    print(f"{ARCHIVO} parchado OK: version 1.3 -> 1.4")
    print("")
