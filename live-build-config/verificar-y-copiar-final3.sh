#!/bin/bash
# verificar-y-copiar-final3.sh - Verifica que make/gcc/gtk-dev quedaron
...
echo ""
echo "=== 7) gcc presente ==="
test -f /tmp/squashfs-root/usr/bin/gcc && echo "presente" || echo "FALTA"

echo ""
echo "=== 8) headers de gtk presentes (para compilar la GUI) ==="
test -f /tmp/squashfs-root/usr/include/gtk-3.0/gtk/gtk.h && echo "presente" || echo "FALTA"
