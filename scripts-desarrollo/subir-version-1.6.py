...
Sube el numero de version de PawOS Refugio de 1.5 a 1.6 en
include/version.h.

Uso: parado en la raiz del repo:
    python3 subir-version-1.6.py
"""
...
ANCLA = '#define PAWOS_VERSION "1.5"'
NUEVO = '#define PAWOS_VERSION "1.6"'
...
def main():
    ...
    if contenido.count(ANCLA) != 1:
        ...
        print("       Puede que la version ya no sea 1.5, o que el archivo ya haya sido modificado.")
    ...
    print(f"{ARCHIVO} parchado OK: version 1.5 -> 1.6")
    print("")
