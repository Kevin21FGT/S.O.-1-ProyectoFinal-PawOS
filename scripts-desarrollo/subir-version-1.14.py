...
ANCLA = '#define PAWOS_VERSION "1.13"'
NUEVO = '#define PAWOS_VERSION "1.14"'
...
def main():
    ...
    if contenido.count(ANCLA) != 1:
        print("ERROR: no se encontro la version 1.13 esperada en version.h. No se cambio nada.")
        sys.exit(1)
    ...
    with open(ARCHIVO, "w", encoding="utf-8") as f:
        f.write(contenido)
    print(f"{ARCHIVO} parchado OK: version 1.13 -> 1.14.")
