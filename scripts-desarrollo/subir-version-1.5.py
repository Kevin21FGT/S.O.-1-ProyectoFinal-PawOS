...
Sube el numero de version de PawOS Refugio de 1.4 a 1.5 en
include/version.h.

Uso: parado en la raiz del repo:
    python3 subir-version-1.5.py
"""
...
ANCLA = '#define PAWOS_VERSION "1.4"'
NUEVO = '#define PAWOS_VERSION "1.5"'
...
def main():
    ...
    if contenido.count(ANCLA) != 1:
        ...
        print("       Puede que la version ya no sea 1.4, o que el archivo ya haya sido modificado.")
    ...
    print(f"{ARCHIVO} parchado OK: version 1.4 -> 1.5")
    print("")
