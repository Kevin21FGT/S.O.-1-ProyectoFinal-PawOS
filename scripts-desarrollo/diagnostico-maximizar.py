...
# -*- coding: utf-8 -*-
"""
Parche TEMPORAL de diagnostico. Agrega g_print() dentro de
on_click_maximizar_restaurar para ver, en el momento exacto del clic,
que valores esta calculando: tamaño actual de la ventana, tamaño del
monitor, y si decide que "parece_maximizada" o no. Esto es lo unico que
nos falta saber para explicar por que el boton no cambia nada.

No cambia ningun comportamiento, solo agrega impresiones a la terminal.
Es facil de revertir (o de dejar, no afecta nada en produccion) despues
de ver el resultado.
"""
import shutil
import sys
...
def main():
    ...
    print("Se agregaron impresiones [DIAG] dentro de on_click_maximizar_restaurar.")
    print("Vuelve a compilar con 'make gui' y corre ./pawos-refugio-gui DESDE LA TERMINAL")
    print("(no lo cierres), haz clic en el boton de maximizar, y copia todo lo que")
    print("empiece con [DIAG] que aparezca en la terminal.")
